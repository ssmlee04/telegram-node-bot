...
class Scope {
    ...
    deleteMessage(message_id, options) {
        return this._api.deleteMessage(this.chatId, message_id, options)
    }
    ...
    sendMediaGroup(media, options) {
        return this._api.sendMediaGroup(this.chatId, media, options)
    }
